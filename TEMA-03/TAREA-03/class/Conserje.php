...
class Conserje extends Trabajador
{
    ...
    {
        $sexo = rand(0, 1);
        return new Conserje($sexo == 0 ? "Pedro" : "Mónica", "López", "Castilla", date('d/m/Y', strtotime('1994-12-23')), "12345678Z", "López Mora 13C", [rand(600000000, 699999999), rand(600000000, 699999999)], $sexo, rand(0, 30));
    }
